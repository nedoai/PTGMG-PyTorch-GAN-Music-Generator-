...
from cfg import def_audio_path, def_description_path
...
audio_path = def_audio_path
description_path = def_description_path
...
dataset = AudioDataset(audio_files, descriptions, max_time_steps)
